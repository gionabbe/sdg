...
$.noty.themes.jiraTheme = {
    ...
    style   : function() {
        ...
        this.$icon = this.$message.find('.noty_icon');
        ...
        switch(this.options.type) {
            case 'alert':
            case 'notification':
                this.$bar.css({backgroundColor: '#FFF', borderColor: '#dedede', color: '#666'});
                this.$icon.css({
                ...
                break;
            case 'warning':
                this.$bar.css({backgroundColor: '#FFF', borderColor: '#f6c342', color: '#666'});
                this.$buttons.css({borderTop: '1px solid #FFC237'});
                this.$icon.css({
                    backgroundPosition  : "15px center",
                    backgroundImage     : "url(data:image/png;base64,)",
                ...
                break;
            case 'error':
                this.$bar.css({backgroundColor: '#FFF', borderColor: '#d04437', color: '#666'});
                //this.$message.css({fontWeight: 'bold'});
                this.$buttons.css({borderTop: '1px solid darkred'});
                this.$icon.css({
                    backgroundPosition  : "15px center",
                ...
                break;
            case 'information':
                this.$bar.css({backgroundColor: '#FFF', borderColor: '#3572b0', color: '#666'});
                this.$buttons.css({borderTop: '1px solid #0B90C4'});
                this.$icon.css({
                    backgroundPosition  : "15px center",
                ...
                break;
            case 'success':
                this.$bar.css({backgroundColor: '#FFF', borderColor: '#8eb021', color: '#666'});
                this.$buttons.css({borderTop: '1px solid #50C24E'});
                this.$icon.css({
                    backgroundPosition  : "15px center",
